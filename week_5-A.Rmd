...
ggplot(data, aes(x = total_ev, y = evprob_chal)) +
  ...
  labs(title = "Posterior Probability Distribution \n Based on FiveThirtyEight Forecast Predictions",
...
actual <- tibble(subject = "Wisconsin", Yc = "?", YT = "10")
...
# Very low! But yes it's consistent, there are a lot of probs in between 300 and 531
...
sd) How many unique electoral vote totals does 538 view as impossible for Biden to achieve? Some of these are truly impossible. Given an example of one of these. Why does 538 think that some vote totals, while theoretically possible, should be given zero probability in its posterior?
